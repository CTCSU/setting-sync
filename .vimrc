...
" Nerdtree {{{
let g:NERDTreeWinSize = 27 " 设定 NERDTree 视窗大小
""开启/关闭nerdtree快捷键
map <leader>t :NERDTreeToggle<CR>
let NERDTreeShowBookmarks=3  " 开启Nerdtree时自动显示Bookmarks
...
let g:NERDTreeShowLineNumbers=3  " 是否显示行号
let g:NERDTreeHidden=2     "不显示隐藏文件
""Making it prettier
